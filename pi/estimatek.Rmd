...
output, and also creates a HTML document.  On recent machines, once
	bookdown, rmarkdown and kntir are installed, you should be able to
...
knitr is newer than Sweave, and is more flexible.  Both estimatek.Rmd
and estimatek.html are available from:
...
2. Experiment switching the cache on.  Where are the intermediate
   results stored?  When is the code rerun?
